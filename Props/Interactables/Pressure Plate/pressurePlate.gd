...
@onready var audioActivate : AudioStream = preload("res://Resources/Michael Games Sprites/lever-01.wav")
@onready var audioDeactivate : AudioStream = preload("res://Resources/Michael Games Sprites/lever-02.wav")
